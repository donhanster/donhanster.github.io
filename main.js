...
var AppComponent = /** @class */ (function () {
    ...
    AppComponent.prototype.generateBest = function () {
        ...
        this.combos = [];
        this.tempHelmets = this.helmets;
        this.tempWeapons = this.weapons;
        this.tempArmors = this.armors;
        this.tempNecklaces = this.necklaces;
        this.tempRings = this.rings;
        this.tempBoots = this.boots;
        var combos = []; // {stats:{}, idx:[]}
        this.statFilters.forEach(function (s) {
            s.resultCnt = 0;
        });
        this.tempHelmets = this.findBest(this.tempHelmets, this.statFilters[0].statName, this.bestStatMaxEquip);
        this.tempWeapons = this.findBest(this.tempWeapons, this.statFilters[0].statName, this.bestStatMaxEquip);
        this.tempArmors = this.findBest(this.tempArmors, this.statFilters[0].statName, this.bestStatMaxEquip);
        this.tempNecklaces = this.findBest(this.tempNecklaces, this.statFilters[0].statName, this.bestStatMaxEquip);
        this.tempRings = this.findBest(this.tempRings, this.statFilters[0].statName, this.bestStatMaxEquip);
        this.tempBoots = this.findBest(this.tempBoots, this.statFilters[0].statName, this.bestStatMaxEquip);
        combos = this.generateAllCombos(this.tempWeapons, this.tempHelmets, this.tempArmors, this.tempNecklaces, this.tempRings, this.tempBoots, this.statFilters[0]);
    ...
    AppComponent.prototype.addBestSet = function (combo, idx) {
        ...
        us.name = "combo" + idx;
        us.equipment = [this.tempWeapons[combo.idx[0]], this.tempHelmets[combo.idx[1]], this.tempArmors[combo.idx[2]], this.tempNecklaces[combo.idx[3]], this.tempRings[combo.idx[4]], this.tempBoots[combo.idx[5]]];
        if (!this.equipmentSets) {
            this.equipmentSets = [];
        }
        this.equipmentSets.push(us);
        this.combos[idx].added = true;
    };
    ...
    AppComponent.prototype.findBest = function (arr, statName, topNums) {
        var _this = this;
        // we want to start with the topNums of the list, but then extend the last one to all equal values. ie. if array is 9,8,7,6,5,5,4 and topNums is 5. we want 9,8,7,6,5,5 and not 9,8,7,6,5
        var actualTop = topNums;
        ...
        var topX = [];
        var lowestStat = 0;
        sortedArr.forEach(function (b) {
            //console.log("processing ", b, statName);
            var statVal = this.getNumber(b.stats[statName]);
            if (topX.length < topNums) {
                topX.push(b);
            }
            else if (lowestStat === 0) {
                lowestStat = statVal;
            }
            if (lowestStat > 0 && statVal === lowestStat) {
                topX.push(b);
                actualTop++;
            }
        }, this);
        ...
        for (var i = actualTop; i < sortedArr.length; i++) {
...
module.exports = "\n/*# sourceMappingURL=data:application/json;base64,eyJ2ZXJzaW9uIjozLCJzb3VyY2VzIjpbXSwibmFtZXMiOltdLCJtYXBwaW5ncyI6IiIsImZpbGUiOiJhcHAvZXF1aXBtZW50LWxpc3QvZXF1aXBtZW50LWxpc3QuY29tcG9uZW50LmNzcyJ9 */"
